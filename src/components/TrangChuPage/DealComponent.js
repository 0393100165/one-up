                ...
                <div className="col">
                    <div className="row" style={{ height: 50, width: '100%', padding: 10, marginBottom: 20 }}>
                        ...
                        <div className="col" style={{ height: 'auto' }}>
                            <h5 style={{ color: 'orange' }}><strong>OneUp Deal</strong></h5>
                            <p style={{ lineHeight: 1 }}>Cập nhật hàng giờ tất cả những deal giảm giá đặc biệt trên OneUp. Hãy bookmark trang này và quay lại thường xuyên để không bỏ lỡ bạn nhé!</p>
                        </div>
                    </div>
                    <div className="row">
                        {
